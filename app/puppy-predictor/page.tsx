    ...
    <div className="min-h-screen" style={{ background: "#EDE4D5" }}>
      <div className="max-w-[1200px] mx-auto px-4 md:px-6 py-8 space-y-6">
        ...
        <div className="text-center space-y-2">
          ...
          <p style={{ color: "#4A4A4A", fontFamily: "var(--font-table)", fontSize: "0.95rem" }}>
        ...
        {showHistory && (
          <div className="rounded-lg p-4 space-y-2" style={{
            ...
            {history.length === 0 ? (
              <p className="text-xs text-center py-4" style={{ color: "#4A4A4A", fontFamily: "var(--font-table)" }}>No prediction history yet.</p>
            ) : (
