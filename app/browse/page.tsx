...
function DogCard({ dog, index }: { dog: Dog; index: number }) {
  ...
  return (
    <Link href={`/pedigree/${dog.id}`}
      ...
      {/* Photo */}
      <div className="relative h-36 overflow-hidden" style={{ borderBottom: "2px solid #EDE4D5" }}>
        {photoUrl ? (
      ...
      <div className="px-2.5 pb-2.5 pt-2 relative">
        ...
        {dog.color && (
          <span className="inline-block text-[9px] px-1.5 py-0.5 rounded mb-1.5"
            style={{ background: "#FAFAFA", border: "1px solid #EDE4D5", color: "#6B6B6B", fontFamily: "var(--font-table)" }}>
            {dog.color}
          </span>
        )}
        ...
        <div className="flex items-center justify-between mt-1.5 pt-1 text-[8px]"
          style={{ borderTop: "1px solid #EDE4D5", color: "#6B6B6B", fontFamily: "var(--font-mono)" }}>
      ...
      <div className="relative overflow-hidden">
        <div className="relative max-w-[1600px] mx-auto px-4 md:px-6 pt-8 pb-5">
          ...
          <div className="flex flex-wrap items-center gap-2">
            {/* Sex filter pills */}
            <div className="flex items-center gap-1 p-0.5" style={{ border: "2px solid #EDE4D5", borderRadius: "8px", background: "#FAF7F2" }}>
              {[
            ...
            {(search || activeFilters > 0) && (
              <button onClick={clearFilters}
                ...
                style={{ color: "#dc2626", background: "rgba(220,38,38,0.06)", fontFamily: "var(--font-table)", border: "2px solid #EDE4D5", borderRadius: "8px" }}>
                ✕ Clear
              </button>
            )}
          </div>
          ...
          {showFilters && (
            <div className="mt-2 p-3 flex flex-wrap items-center gap-2"
              style={{ border: "2px solid #EDE4D5", borderRadius: "8px", background: "#FAF7F2", animation: "cardReveal 0.2s ease both" }}>
              ...
              {[
                ...
                <button key={s.key}
                  ...
                  style={{
                    ...
                    border: sort === s.key ? "1px solid #EDE4D5" : "1px solid transparent",
                    fontFamily: "var(--font-table)",
                  }}>
        ...
        {loading ? (
            ...
            {initialLoad ? (
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-2.5">
                {Array.from({ length: 18 }).map((_, i) => (
                  <div key={i} className="overflow-hidden" style={{ border: "2px solid #EDE4D5", borderRadius: "8px", background: "#FAF7F2" }}>
          ...
          <div className="text-center py-20">
            ...
            <button onClick={clearFilters}
              ...
              style={{ background: "rgba(29,91,191,0.06)", color: "#1d5bbf", border: "2px solid #EDE4D5", fontFamily: "var(--font-table)", borderRadius: "8px" }}>
              Clear All Filters
            </button>
          </div>
        ) : (
              ...
              <div className="mt-8 flex flex-col items-center gap-3">
                ...
                <div className="flex items-center gap-1.5">
                  ...
                  <button onClick={() => goToPage(page - 1)} disabled={page === 1}
                    ...
                    style={{ background: "#FAF7F2", color: "#6B6B6B", border: "2px solid #EDE4D5", fontFamily: "var(--font-table)", borderRadius: "8px" }}>
                    ←
                  </button>
                      ...
                      typeof p === "string" ? (
                        ...
                        <button key={p} onClick={() => goToPage(p)}
                          ...
                          style={{
                            ...
                            border: page === p ? "2px solid #1d5bbf" : "2px solid #EDE4D5",
