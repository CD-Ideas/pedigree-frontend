            ...
            <table className="w-full text-sm">
              <thead>
                <tr style={{ background: "#1C1C1C", borderBottom: "2px solid #C9B29F" }}>
                  ...
                  <th className="text-left px-3 py-2 text-[12px] uppercase tracking-wider font-bold hidden lg:table-cell" style={{ color: "#FAF7F2", fontFamily: "var(--font-table)" }}>Owner</th>
                  ...
                  <th className="text-left px-3 py-2 text-[12px] uppercase tracking-wider font-bold hidden md:table-cell" style={{ color: "#FAF7F2", fontFamily: "var(--font-table)" }}>Views</th>
                </tr>
              </thead>
              <tbody>
                {paginated.map((p) => {
