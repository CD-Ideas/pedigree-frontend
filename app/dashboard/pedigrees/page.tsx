            ...
            <table className="w-full text-sm">
              <thead>
                <tr style={{ borderBottom: "2px solid #C9B29F" }}>
                  ...
                  <th className="text-left px-3 py-2 text-[12px] uppercase tracking-wider font-medium hidden md:table-cell" style={{ color: "#4A4A4A", fontFamily: "var(--font-table)" }}>Breeder</th>
                  <th className="text-left px-3 py-2 text-[12px] uppercase tracking-wider font-medium hidden lg:table-cell" style={{ color: "#4A4A4A", fontFamily: "var(--font-table)" }}>Owner</th>
                  ...
                  <th className="text-left px-3 py-2 text-[12px] uppercase tracking-wider font-medium hidden md:table-cell" style={{ color: "#4A4A4A", fontFamily: "var(--font-table)" }}>Views</th>
                </tr>
              </thead>
              <tbody>
                {paginated.map((p) => {
