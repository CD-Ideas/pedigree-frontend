      ...
      <div className="max-w-6xl mx-auto px-4 py-6">
        ...
        {loading ? (
          ...
          <div className="space-y-3">
            {filtered.map(a => (
              <Link key={a.id} href={`/pedigree/custom/${a.id}`} className="flex items-center gap-4 p-4 rounded-lg transition-all hover:shadow-lg" style={{ background: "#FAF7F2", border: "2px solid #C9B29F", borderRadius: "8px", textDecoration: "none" }}>
                ...
                <div className="flex-1 min-w-0">
                  <p className="text-sm font-bold truncate" style={{ color: "#1C1C1C", fontFamily: "var(--font-table)" }}>{buildDisplayName(a)}</p>
