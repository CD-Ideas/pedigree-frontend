export default function TermsPage() {
  return (
    <div className="min-h-screen px-4 py-20" style={{ background: "#FAFAFA" }}>
      <div className="max-w-3xl mx-auto">
        ...
        <div style={{ fontFamily: "var(--font-table)", fontSize: "14px", color: "#6B7280", lineHeight: 1.8 }} className="space-y-5">
          ...
          <h2 style={{ fontFamily: "var(--font-table)", fontWeight: 600, fontSize: "1.1rem", color: "#1C1C1C" }}>2. Account Registration</h2>
          ...
          <h2 style={{ fontFamily: "var(--font-table)", fontWeight: 600, fontSize: "1.1rem", color: "#1C1C1C" }}>3. Acceptable Use</h2>
          ...
          <h2 style={{ fontFamily: "var(--font-table)", fontWeight: 600, fontSize: "1.1rem", color: "#1C1C1C" }}>4. Marketplace</h2>
          ...
          <h2 style={{ fontFamily: "var(--font-table)", fontWeight: 600, fontSize: "1.1rem", color: "#1C1C1C" }}>5. Intellectual Property</h2>
          ...
          <h2 style={{ fontFamily: "var(--font-table)", fontWeight: 600, fontSize: "1.1rem", color: "#1C1C1C" }}>6. Subscription & Billing</h2>
          ...
          <h2 style={{ fontFamily: "var(--font-table)", fontWeight: 600, fontSize: "1.1rem", color: "#1C1C1C" }}>7. Limitation of Liability</h2>
