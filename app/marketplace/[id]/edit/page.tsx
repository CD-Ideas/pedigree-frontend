                  ...
                  >
                    {dogSearchResults.map((dog) => (
                      <button
                        ...
                        type="button"
                        onClick={() => {
                          const dId = dog.dog_id || dog.id;
                          const dName = dog.registered_name || dog.name;
                          setDogId(dId);
                          setSelectedDogName(dName);
                          setTitle(dName);
          ...
          >
            ...
            <input
              ...
              style={{
                ...
                border: selectedDogName ? "1px solid rgba(201,178,159,0.3)" : "1px solid #EDE4D5",
